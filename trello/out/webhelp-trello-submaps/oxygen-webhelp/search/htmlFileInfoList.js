...
fil["7"]= "source/t_creating-an-user-account.html@@@Creating a user account@@@To create a user account in Trello: If you have an email invitation, click the hyperlink ( View Organization ) in the email message, then when the organization page opens in your browser, click Join...";
